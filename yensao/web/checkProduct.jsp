...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Check product application</title>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">Check Product Application</strong>                                  
                                </div>
                                <c:if test="${requestScope.APPROVAL_PRODUCT != null}">
                                    <div class="col-sm-12">
                                        <div class="alert  alert-success alert-dismissible fade show" role="alert">
                                            <span class="badge badge-pill badge-success">Success</span> ${requestScope.APPROVAL_PRODUCT}
