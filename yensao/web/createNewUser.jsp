<%-- 
    Document   : sellSelling
    Created on : Sep 19, 2022, 3:12:17 PM
    Author     : lequa
--%>
...
<html class="no-js" lang="en">
    ...
    <body>
        ...
        <aside id="left-panel" class="left-panel">
            <nav class="navbar navbar-expand-sm navbar-default">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="./"><img src="adminPage/favicon.ico" alt="Logo"></a>
                    <a class="navbar-brand hidden" href="./"><img src="adminPage/favicon.ico" alt="Logo"></a>
                </div>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                <li><i class="fa fa-table"></i><a href="tables-basic.html">Customer list</a></li>
                                <li><i class="fa fa-table"></i><a href="MainController?action=Show">Seller list</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="MainController?action=Request"><i class="menu-icon fa fa-th"></i>Approve selling request</a>
                        </li>
                        <li>
                            <a href="MainController?action=High"><i class="menu-icon fa fa-th"></i>Best-selling products</a>
                        </li>
                        <li>
                            <a href="createNewUser.jsp"><i class="menu-icon fa fa-th"></i>Create new user</a>
                        </li>
                        <li>
                            <a href="MainController?action=Report"><i class="menu-icon fa fa-th"></i>Customer report</a>
                        </li>
                        <li>
                            <a href="checkProduct.jsp"><i class="menu-icon fa fa-th"></i>Check Product Application</a>
                        </li>
                    ...
                    <div class="card">
                        <div class="card">
                            <div class="card-header">
                                <strong>Create user</strong> (customer/seller)
                            </div>
                            <div class="card-body card-block">
                                <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label"><i class="fa fa-calendar"></i> User name</label></div>
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="text-input"
                                                                            placeholder="Enter Username" class="form-control"><small
                                                                            class="form-text text-muted">Username</small>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">Password</label></div>
                                        <div class="col-12 col-md-9"><input type="password" id="text-input" name="text-input"
                                                                            placeholder="Enter Password" class="form-control"><small
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">Phone
                                            </label></div>
                                        <div class="col-12 col-md-9"><input type="email" id="email-input" name="email-input"
                                                                            placeholder="Enter Phone" class="form-control"><small
                                    ...
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">Location
                                            </label></div>
                                        <div class="col-12 col-md-9"><input type="email" id="email-input" name="email-input"
                                                                            placeholder="Enter Location" class="form-control"><small
        ...
        <script src="adminPage/vendors/jquery-validation/dist/jquery.validate.min.js"></script>
        <script src="adminPage/vendors/jquery-validation-unobtrusive/dist/jquery.validate.unobtrusive.min.js"></script>
