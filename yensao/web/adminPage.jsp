<%-- 
    Document   : index.jsp
    Created on : Oct 4, 2022, 6:10:36 PM
    Author     : Truong Giang
--%>
...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="adminPage/vendors/jqvmap/dist/jqvmap.min.css">
    ...
    <body>
        ...
        <script src="adminPage/vendors/chart.js/dist/Chart.bundle.min.js"></script>
        <script src="adminPage/assets/js/dashboard.js"></script>
        <script src="adminPage/assets/js/widgets.js"></script>
        <script src="adminPage/vendors/jqvmap/dist/jquery.vmap.min.js"></script>
        <script src="adminPage/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js"></script>
        <script src="adminPage/vendors/jqvmap/dist/maps/jquery.vmap.world.js"></script>
        <script>
            (function ($) {
                "use strict";
