                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="menu-item-has-children dropdown">
                            ...
                            <ul class="sub-menu children dropdown-menu">
                                ...
                                <li><i class="fa fa-table"></i><a href="sellerList.jsp">Seller list</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="#"><i class="menu-icon fa fa-th"></i>Approve selling request</a>
                        </li>
                        <li>
                            <a href="highProduct.jsp"><i class="menu-icon fa fa-th"></i>Best-selling products</a>
                        </li>
                        <li>
                            <a href="#"><i class="menu-icon fa fa-th"></i>Create new user</a>
                        </li>
                        <li>
                            <a href="#"><i class="menu-icon fa fa-th"></i>Customer report</a>
                        </li>
                        <li>
                            <a href="#"><i class="menu-icon fa fa-th"></i>Check Product Application</a>
                        </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <c:if test="${requestScope.sellerList != null}">
                                        <c:if test="${not empty requestScope.sellerList}">
                                            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    <c:forEach var="seller" varStatus="counter" items="${requestScope.sellerList}"> 
                                                        <tr>
