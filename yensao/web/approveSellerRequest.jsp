<%-- 
    Document   : requestBeSeller
    Created on : Sep 24, 2022, 2:28:35 PM
    Author     : lequa
--%>
...
<html class="no-js" lang="en">
    <head>
        ...
        <title>Approve seller request</title>
                    ...
                    <div class="page-header float-right">
                        <div class="page-title">
                            <ol class="breadcrumb text-right">
                                ...
                                <li class="active"> Approve Selling Request</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <c:if test="${requestScope.APPROVAL_REQUEST != null}">
                                    <br/>
                                    <div class="col-sm-12">
                                        <div class="alert  alert-success alert-dismissible fade show" role="alert">
                                            <span class="badge badge-pill badge-success">Success</span> ${requestScope.APPROVAL_REQUEST}
                                                    ...
                                                    <form action="MainController">
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type="hidden" name="cusID" value="${request.cusId}"/>
                                                                <input class="inputApprove" type="submit" name="action" value="ApprovalRequest"/>
                                                            </td>
                                                        </tr>  
                                                    </form>
                                                </c:forEach>
