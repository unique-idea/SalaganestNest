                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <c:if test="${requestScope.REPORT_LIST != null}">
                                        <c:if test="${not empty requestScope.REPORT_LIST}">
                                            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    <c:forEach var="report" varStatus="counter" items="${requestScope.REPORT_LIST}"> 
                                                        <tr>
                                                            <td>${report.cusID}</td>
                                                            <td>${report.productID}</td>
                                                            <td>${report.description}</td>
                                                            <td>${report.dateReport}</td>
                                                            <td><img class="avatar-seller" src="${report.img}" alt="alt"/></td>
                                                        </tr>                                                 
                                                    </c:forEach>
                                                </tbody>
                                            </table>
                                    ...
                                    <% String error = (String) request.getAttribute("NO_REPORT_LIST");
                                        if (error == null) {
                                            error = "";
                                        }%>
                                    <%= error%>
