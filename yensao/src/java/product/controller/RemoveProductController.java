...
public class RemoveProductController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean check = ProductDAO.removeProduct(productID);
            if (check) {
                request.setAttribute("REMOVE_SUCCESS", "The product has been removed successfully");
                url = SUCCESS;
            } else {
                request.setAttribute("REMOVE_SUCCESS", "Fail to Remove Product");
            }
