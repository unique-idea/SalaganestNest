...
public class GetReportController extends HttpServlet {
    ...
    private static final String SUCCESS = "checkReport.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = ERROR;
        try {
            ArrayList<ReportDTO> list = ManagerDAO.getReportList();
            if (list != null) {
                request.setAttribute("REPORT_LIST", list);
                url = SUCCESS;
            }else{
                request.setAttribute("NO_REPORT_LIST", "There Have No Report");
            }
        } catch (Exception e) {
            log("Error at GetReportController: " + e.toString());
        } finally {
